...
describe('SidebarThumbnailComponent', () => {
    ...
    it('should use internally a generic-thumbnail', () => {
        ...
        let element = compiled.querySelector('generic-thumbnail');
    ...
    it('should be able to set an image', () => {
        ...
        var nestedComponentInstance: GenericThumbnailComponent = nestedComponentDebugElement.componentInstance;
